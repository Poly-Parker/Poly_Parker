...
public class LotInfo extends ParseObject{
    ...
    public void printDateCompare(){
        Log.i("~TIMEDEBUG~Instance", "" + getInt("hour") + ":" + minute + "::" + dayOfMonth + "," + month  + "," + year);
        Calendar cal = Calendar.getInstance();
        Log.i("~TIMEDEBUG-Compare~", "" + cal.get(Calendar.HOUR) + ":" + cal.get(Calendar.MINUTE) + "::" + cal.get(Calendar.DAY_OF_MONTH) + "," + cal.get(Calendar.MONTH)  + "," + cal.get(Calendar.YEAR));
    }
}
